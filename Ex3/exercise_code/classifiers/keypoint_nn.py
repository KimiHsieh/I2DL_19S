...
class KeypointModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_1 = nn.Conv2d(
            in_channels=1, out_channels=32, kernel_size=4, stride=1, bias=True)
        self.maxpool_1 = nn.MaxPool2d(kernel_size=(2, 2))
        self.dropout_1 = nn.Dropout(p=0.1)

        self.conv_2 = nn.Conv2d(
            in_channels=32, out_channels=64, kernel_size=3, stride=1, bias=True)
        self.maxpool_2 = nn.MaxPool2d(kernel_size=(2, 2))
        self.dropout_2 = nn.Dropout(p=0.2)

        self.conv_3 = nn.Conv2d(
            in_channels=64, out_channels=128, kernel_size=2, stride=1, bias=True)
        self.maxpool_3 = nn.MaxPool2d(kernel_size=(2, 2))
        self.dropout_3 = nn.Dropout(p=0.3)

        self.conv_4 = nn.Conv2d(
            in_channels=128, out_channels=256, kernel_size=1, stride=1, bias=True)
